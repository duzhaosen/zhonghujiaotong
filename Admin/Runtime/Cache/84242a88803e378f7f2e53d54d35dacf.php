...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="LineRightBlue1">
  <tr>
    <td>
      <div style="float:left; width:312px;"><a class="tab_top_btn" href="<?php echo U('Photo/add');?>">添加图片</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:select()">全选</a> | <a href="javascript:fanselect()">反选</a> | <a href="javascript:noselect()">全不选</a>
      </div>
...
<form name="theForm" method="post" id="theForm" action="">
  ...
  <div id="languageBox2">
    <div class="tablelist">
    <?php if(is_array($photo)): $i = 0; $__LIST__ = $photo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><ul onmouseover="this.style.background ='#FFFDD7'" onmouseout="this.style.background ='#FFFFFF'" class="tb_list">
          ...
          <li class="li_50">
            ...
            <span class="f_no">
              <a class="nowrap" href="<?php echo U('mod',array('id'=>$vo['id']));?>" title="<?php echo ($vo["name"]); ?>"><?php echo (mb_substr($vo["name"],0,22,'utf-8')); ?></a></span>
          </li>
          <li class="li_10"><?php echo ($vo["id"]); ?></li>
          <li class="li_10 state_col">
            <a href="<?php echo U("Photo/featured",array("table"=>"photo",'id'=>$vo['id']));?>" data-featured="<?php echo ($vo["featured"]); ?>"  class="set_featured">
