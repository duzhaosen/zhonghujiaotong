...
<table width="100%" border="0" class="ListCategory">
  ...
  <tr>
    ...
    <td height="35" style="padding:5px 0px;">
      ...
      <?php else: ?>
        <a href="__ROOT__/Uploads/<?php echo (C("water_logo")); ?>" target='_blank'>
          <img class="upload_img left" src="__ROOT__/Uploads/<?php echo (C("water_logo")); ?>" width="80" height="30"/>
        </a>
        <a class="del_img left" href="__APP__?m=config&a=dellogo&name=<?php echo (C("water_logo")); ?>&type=water"></a><?php endif; ?>
