...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="LineRightBlue1">
  <tr>
    <td>
      <div style="float:left; width:312px;"><a class="tab_top_btn" href="<?php echo U('New/add');?>">添加新闻</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:select()">全选</a> | <a href="javascript:fanselect()">反选</a> | <a href="javascript:noselect()">全不选</a>
      </div>
...
<form name="theForm" id="theForm" method="post" action="">
  ...
  <div id="languageBox2">
    <div class="tablelist">
    <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><ul onmouseover="this.style.background ='#FFFDD7'" onmouseout="this.style.background ='#FFFFFF'">
          <li class="li_10">
          ...
          <li class="li_50">
          <img class="proimg" src="__ROOT__/Uploads/<?php echo ($vo["photo"]); ?>" onerror="this.src='../Public/images/error.jpg'"/>
            <a href="<?php echo U('mod',array('id'=>$vo['id']));?>" title="<?php echo ($vo["title"]); ?>"><?php echo ($vo["title"]); ?></a>
          </li>

          <li class="li_10"><?php echo ($vo["id"]); ?></li>
          <li class="li_10 state_col"><a href="<?php echo U("New/featured",array("table"=>"new",'id'=>$vo['id']));?>" data-featured="<?php echo ($vo["featured"]); ?>"  class="set_featured">
