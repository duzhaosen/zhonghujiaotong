...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="LineRightBlue1">
  <tr>
    <td width="88%" height="24"><a class="tab_top_btn" href="<?php echo U('Ad/add');?>">添加广告</a></td>
...
<form name="theForm" method="post" action="<?php echo U('uporder');?>">
  ...
  <div id="languageBox2">
    <div class="tablelist">
    <?php if(is_array($ad)): $i = 0; $__LIST__ = $ad;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><ul onmouseover="this.style.background ='#FFFDD7'" onmouseout="this.style.background ='#FFFFFF'"  class="tb_list">
      ...
      <td height="36" class="BotNavBg">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="92%" align="right"><small>提示：删除广告会导致前台调用失败，请谨慎删除，若重新添加广告请在前台修改对应id重新调用</small> &nbsp;&nbsp;&nbsp;&nbsp;</td>
          </tr>
        </table>
      </td>
    </tr>
