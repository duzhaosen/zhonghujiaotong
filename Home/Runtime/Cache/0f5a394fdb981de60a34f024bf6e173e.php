...
<title><?php echo (C("seo_title")); ?>|<?php echo ($news["title"]); ?></title>
...
<div class="container">
<div class="page_banner"><?php echo W('Ad',array('id'=>'13'));?></div>

<div class="main">
    <?php echo W('Left',array('id'=>$news['bid'],'type'=>'new'));?>
  <!-- end of left -->
    <div id="right">
      <div class="path_title" style="clip-path: none;"><span class="span_left"><?php echo (mb_substr($news["title"],0,20,'utf-8')); ?></span><span class="span_right">您现在的位置：<a href="__ROOT__/">网站首页</a> &gt; <?php echo (mb_substr($news["title"],0,15,'utf-8')); ?></span></div>
      <div class="content" style="background: #fff;padding:10px;margin-top:20px;">
        <h1 class="content_title"><?php echo ($news["title"]); ?></h1>
        <small class="time">发布时间: <?php echo (date("Y-m-d",$news["time"])); ?></small>
        <div class="news_info">
